 ...
 */
@Service
public class JZhen_PaperExtractTask {
	@Autowired
	...
	public void executeZhen() {
		...
		for(ShijuanVo sjv : list){
			...
			pcategorys.add("yj00"+sjv.getCategory());
	...
	private List<ShijuanVo> getShujuanZhenList(){
		...
		JdbcUtil db1 = null;
		ResultSet ret = null;
		//bl_exam_sub !='3' 为教师        and  simulate='0' 为真题
		quessql = "select PUKEY,pastpaper_name,past_area,past_year,bl_exam_sub from v_pastpaper_info where bl_exam_sub !='3' and  simulate='0' ";// SQL语句
