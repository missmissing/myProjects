...
<script type="text/javascript">
	$(function() {
		...
		$("#close").bind("click", function() {
			dhxListWins.window("winsView").close();
		});
	});
			...
			<form id="questionForm" method="post" accept-charset="utf-8" enctype="multipart/form-data">
				...
				<table class="form_table">
					...
					<tr>
						<th>考试分类：</th>
						<td>
							<select name="question.qcategory"  id="qcategory" multiple disabled>
					...
					<tr >
						<th></th>
						<td>
							<input type="button" class="submit" id="fanhui" value="关闭" onclick="fanhuii();"></input>
						</td>
					</tr>
