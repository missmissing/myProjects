...
//#}	
	...
	*/
	this.createWindow = function(id, x, y, width, height) {
		...
		win.icons = new Array(this.imagePath+"/active/icon_normal.gif", this.imagePath+this.pathPrefix+this.skin+"/inactive/icon_normal.gif");
		//
		win._allowMove = true;
...
//#}	
	...
	this._restoreWindowIcons = function(win) {
		win.iconsPresent = true;
		win.icons[0] = this.imagePath+ "/active/icon_normal.gif";
		win.icons[1] = this.imagePath+ "/inactive/icon_normal.gif";
