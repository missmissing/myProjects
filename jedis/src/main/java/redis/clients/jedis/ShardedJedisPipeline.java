...
public class ShardedJedisPipeline extends PipelineBase {
  ...
  /**
   * Syncronize pipeline by reading all responses. This setoperation closes the pipeline. In order to
  ...
  /**
   * Syncronize pipeline by reading all responses. This setoperation closes the pipeline. Whenever
